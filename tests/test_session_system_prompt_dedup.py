...
def test_update_system_prompt_for_missing_session_keeps_the_prompt(db, caplog):
    ...
    reports the miss and leaves the stored row alone.
    """
    import logging

    with caplog.at_level(logging.WARNING):
        assert db.update_system_prompt("ghost", "orphaned prompt") is False
